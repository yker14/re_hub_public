sap.ui.define([
	...
	'../../Utilities'
], function (Log, MobileLibrary, Element, FileUtil, Device, HeaderField, UploadSetItem, Util) {
	"use strict";
	 ...
	 */
	var Uploader = Element.extend(Util.nameSpaceHandler("libs.custom.controls.sapmupload.Uploader"), {
		metadata: {
			library: "sap.m",
			publicMethods: [
				"uploadItem",
	...
	Uploader.prototype.uploadItem = function (oItem, aHeaderFields) {
		...
		oXhr.open("GET", this.getUploadUrl(), true);
