...
sap.ui.define([
    ...
    '../../Utilities'
			 ...
			 StandardListItem, Text, ToolbarSpacer, FileUploader, UploadSetItem, Uploader, Renderer, Util) {
	"use strict";
	 ...
	 */
	var UploadSet = Control.extend(Util.nameSpaceHandler("libs.custom.controls.sapmupload.UploadSet"), {
		metadata: {
			library: "sap.m",
			properties: {
				/**
